...
task :compile => [:clean, :version] do
  sh "#{msbuild} src/FubuMVC.WebForms.sln /property:Configuration=#{COMPILE_TARGET} /v:m /t:rebuild /nr:False /maxcpucount:8"
end
...
task :version do
  ...
  options = {
    :description => 'FubuMVC.WebForms',
    :product_name => 'FubuMVC.WebForms',
...
task :fast_test do
  sh "src/packages/NUnit.ConsoleRunner.3.6.1/tools/nunit3-console.exe src/FubuMVC.WebForms.Testing/bin/#{COMPILE_TARGET}/FubuMVC.WebForms.Testing.dll"
end